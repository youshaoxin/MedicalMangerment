...
<body>
<h1>店长登录</h1><a href="${pageContext.request.contextPath}/login.jsp">店员登录</a>
<div class="top">
<form name="userLoginActionForm" id="userLoginActionForm" method="post" action="${pageContext.request.contextPath}/login_adminLogin" target="_parent" >
